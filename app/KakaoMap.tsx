...
function buildPin(p: Judged) {
  ...
  // 노랑 핀은 흰 글자가 안 읽힌다 — 상태별로 글자색을 둔다
  body.style.color = 'fg' in s ? (s as { fg: string }).fg : '#FFFFFF'
